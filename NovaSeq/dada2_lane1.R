...
# Import raw data.
path <- "/work/bcp30/YC_tip1_nova/20230831_Amplicon_PE250/lane_1"
list.files(path)
...
R1.flags <- paste("-g", FWD, "-a", REV.RC, "--minimum-length 200", "--maximum-length 240")
# Trim REV and the reverse-complement of FWD off of R2 (reverse reads)
R2.flags <- paste("-G", REV, "-A", FWD.RC, "--minimum-length 200", "--maximum-length 240")
# Run Cutadapt
...
pdf(file="cutFs_plot_lane1.pdf")
plotQualityProfile(cutFs[1:2])
dev.off()

# Visualize quality profiles of reverse reads.
pdf(file="cutRs_plot_lane1.pdf")
...
# 
# pdf(file="errF_plot_lane_1.pdf")
# errF_plot
# dev.off()
# 
# pdf(file="errR_plot_lane_1.pdf")
# errR_plot
# dev.off()
...
pdf(file="errF_1plot_lane_1.pdf")
errF_1plot
dev.off()

pdf(file="errR_1plot_lane_1.pdf")
errR_1plot
dev.off()
...
# saveRDS(seqtab, file="seqtab_lane_1.rds")
# 
# # Remove chimeras
...
# 
# # Save table as an r data object file
# saveRDS(seqtab.nochim, file="seqtab.nochim_lane_1.rds")
# 
...
# head(seqtab.nochim)
# 
# write.csv(track, file="track_lane_1.csv")
# write.csv(seqtab.nochim, file="seqtab.nochim_lane_1.csv")
# 
# # Export for to QIIME2 for further analysis.
# write.table(t(seqtab.nochim), "q2-seqtab-nochim_lane_1.txt", sep="\t", row.names=TRUE, col.names=NA, quote=FALSE)
# uniquesToFasta(seqtab.nochim, fout='q2-rep-seqs_lane_1.fna', ids=colnames(seqtab.nochim))
# 
...
# Save table as an R data object file
saveRDS(seqtab_1, file="seqtab_1_lane_1.rds")
...
# Save table as an r data object file
saveRDS(seqtab_1.nochim, file="seqtab_1.nochim_lane_1.rds")
...
write.csv(track_1, file="track_1_lane_1.csv")
write.csv(seqtab_1.nochim, file="seqtab_1.nochim_lane_1.csv")

# Export for to QIIME2 for further analysis.
write.table(t(seqtab_1.nochim), "q2-seqtab_1-nochim_lane_1.txt", sep="\t", row.names=TRUE, col.names=NA, quote=FALSE)
uniquesToFasta(seqtab_1.nochim, fout='q2-rep-seqs_1_lane_1.fna', ids=colnames(seqtab_1.nochim))
...
# ############################################
# 
# # Set working directory and load table (if not already loaded).
# setwd("C:/Users/bcp30/OneDrive - Duke University/16S/20230323_LZ_scord7/endosphere/local_R")
# seqtab_1.nochim <- readRDS("seqtab_1.nochim.rds")
# 
# # Assign taxonomy.
# taxa <- assignTaxonomy(seqtab_1.nochim, "silva_nr99_v138.1_train_set.fa.gz", multithread=TRUE)
# 
