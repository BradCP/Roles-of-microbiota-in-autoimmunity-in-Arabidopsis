...
# Import raw data.
path <- "/work/bcp30/YC_tip1_nova/20230831_Amplicon_PE250/lane_2"
list.files(path)
...
pdf(file="cutFs_plot_lane2.pdf")
plotQualityProfile(cutFs[1:2])
dev.off()

# Visualize quality profiles of reverse reads.
pdf(file="cutRs_plot_lane2.pdf")
...
# 
# pdf(file="errF_plot_lane_2.pdf")
# errF_plot
# dev.off()
# 
# pdf(file="errR_plot_lane_2.pdf")
# errR_plot
# dev.off()
...
pdf(file="errF_1plot_lane_2.pdf")
errF_1plot
dev.off()

pdf(file="errR_1plot_lane_2.pdf")
errR_1plot
dev.off()
...
# saveRDS(seqtab, file="seqtab_lane_2.rds")
# 
# # Remove chimeras
...
# 
# # Save table as an r data object file
# saveRDS(seqtab.nochim, file="seqtab.nochim_lane_2.rds")
# 
...
# head(seqtab.nochim)
# 
# write.csv(track, file="track_lane_2.csv")
# write.csv(seqtab.nochim, file="seqtab.nochim_lane_2.csv")
# 
# # Export for to QIIME2 for further analysis.
# write.table(t(seqtab.nochim), "q2-seqtab-nochim_lane_2.txt", sep="\t", row.names=TRUE, col.names=NA, quote=FALSE)
# uniquesToFasta(seqtab.nochim, fout='q2-rep-seqs_lane_2.fna', ids=colnames(seqtab.nochim))
# 
...
# Save table as an R data object file
saveRDS(seqtab_1, file="seqtab_1_lane_2.rds")
...
# Save table as an r data object file
saveRDS(seqtab_1.nochim, file="seqtab_1.nochim_lane_2.rds")
...
write.csv(track_1, file="track_1_lane_2.csv")
write.csv(seqtab_1.nochim, file="seqtab_1.nochim_lane_2.csv")

# Export for to QIIME2 for further analysis.
write.table(t(seqtab_1.nochim), "q2-seqtab_1-nochim_lane_2.txt", sep="\t", row.names=TRUE, col.names=NA, quote=FALSE)
uniquesToFasta(seqtab_1.nochim, fout='q2-rep-seqs_1_lane_2.fna', ids=colnames(seqtab_1.nochim))
